            ...
            <div class="container-fluid page-body-wrapper">
                ...
                @endif
                    ...
                    <h1 class="title_deg">Update Chef</h1>
                        <form action="{{url('update_chef')}}" method="post">
                            @csrf
                            ...
                            <div class="div_center">
                                ...
                                <Input type="text" name="description" value="{{$chef->description}}">
                            </div>
                            <div class="div_center">
                            <label>Chef Category</label>
                                <Select name="category"style="color:black; width:200px;">
                                    <option value="{{$chef->category}}">{{$chef->description}}</option>
                            ...
                            <div class="div_center">
                                ...
                                <Input type="file" name="file" value="{{$chef->file}}">
                            </div>
                            <div class="div_center">
